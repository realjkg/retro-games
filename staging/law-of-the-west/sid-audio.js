...
const SOUNDS={
  ...
  title:   [{w:"pulse",f0:440,vol:0.15,cut:3000,pw:0.22,pw1:0.58,res:8,seq:[[0,0,0.53],[4,0.55,0.53],[7,1.1,0.53],[12,1.65,0.53],[9,2.2,0.805],[7,3.025,0.255],[4,3.3,1.08],[5,4.4,0.53],[9,4.95,0.53],[12,5.5,0.53],[16,6.05,0.53],[14,6.6,1.08],[12,7.7,1.08],[0,8.8,0.53],[4,9.35,0.53],[7,9.9,0.53],[10,10.45,0.53],[0,11,2.18]]},
             {w:"tri",f0:110,vol:0.17,cut:1000,res:3,seq:[[0,0,1.08],[0,1.1,1.08],[-4,2.2,1.08],[-4,3.3,1.08],[3,4.4,1.08],[3,5.5,1.08],[-2,6.6,1.08],[-2,7.7,1.08],[0,8.8,1.08],[0,9.9,1.08],[0,11,2.18]]},
             {w:"pulse",f0:880,vol:0.055,cut:4200,pw:0.5,res:6,seq:[[12,0,0.255],[16,0.275,0.255],[19,0.55,0.53],[0,1.1,1.08],[16,2.2,0.255],[19,2.475,0.255],[24,2.75,0.53],[0,3.3,1.08],[12,4.4,0.255],[16,4.675,0.255],[19,4.95,0.53],[0,5.5,1.08],[12,6.6,2.18]]}],
  dusk:    [{w:"pulse",f0:220,pw:0.25,pw1:0.55,vol:0.15,cut:2800,res:7,
             seq:[[0,0,0.3],[4,0.32,0.3],[7,0.64,0.3],[9,0.96,0.3],
                  [7,1.28,0.3],[4,1.6,0.3],[2,1.92,0.3],[0,2.24,0.7]]},
            {w:"tri",f0:110,vol:0.16,cut:1100,res:3,
             seq:[[0,0,0.62],[5,0.64,0.62],[-5,1.28,0.62],[0,1.92,1.0]]},
            {w:"pulse",f0:440,pw:0.5,vol:0.07,cut:4200,res:6,
             seq:[[0,0.32,0.12],[7,0.64,0.12],[12,0.96,0.12],[7,1.28,0.12],
                  [4,1.6,0.12],[0,1.92,0.12],[12,2.4,0.5]]}],
  ...
  dawn:    [{w:"pulse",f0:196,pw:0.3,pw1:0.52,vol:0.15,cut:2400,cut1:3600,res:7,
             seq:[[0,0,0.34],[7,0.36,0.34],[12,0.72,0.34],[16,1.08,0.34],
                  [19,1.44,0.34],[24,1.8,0.8]]},
            {w:"tri",f0:98,vol:0.16,cut:1000,res:3,
             seq:[[0,0,0.7],[7,0.72,0.7],[12,1.44,1.16]]},
            {w:"pulse",f0:784,pw:0.5,vol:0.05,cut:4600,res:6,
             seq:[[0,0.36,0.1],[7,0.72,0.1],[12,1.08,0.1],[19,1.8,0.6]]}],
  ...
  /* Miss Rose's saloon, four bars of an upright that has seen things */
  piano:   [{w:"pulse",f0:392,pw:0.3,pw1:0.18,vol:0.13,cut:3200,res:5,
             seq:[[0,0,0.14],[4,0.16,0.14],[7,0.32,0.14],[4,0.48,0.14],
                  [0,0.64,0.14],[-3,0.8,0.14],[0,0.96,0.3]]},
            {w:"tri",f0:98,vol:0.13,cut:900,res:3,
             seq:[[0,0,0.3],[7,0.32,0.3],[0,0.64,0.3],[-5,0.96,0.34]]}],
