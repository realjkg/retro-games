...
- Move with the pad or the arrow keys (also WASD). **UP** jumps, and climbs the steps when you
  are standing on them; **DOWN** crawls, and climbs down steps.
- **FIRE** (Space/Z/Enter) swings the machete, fires the pistol, or lights a stick of dynamite.
  **WEAPON** (Q/C) cycles what is in your hands.
- **USE** (X/E) is the one context action: it opens a chest or debris pile and takes what is in
  it, takes the stairs down or up when you are standing on them, and — held facing a dirt wall —
  digs through it.
